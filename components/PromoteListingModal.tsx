      ...
      <div className="bg-brand-surface rounded-2xl shadow-2xl w-full max-w-md border border-brand-border">
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex items-center bg-brand-background p-3 rounded-lg mb-6">
            ...
            <div>
              <p className="text-brand-text-secondary text-sm">Выбранный товар:</p>
              <p className="font-semibold text-white">{product.title}</p>
            </div>
          </div>
          
          <div className="text-center mb-6">
              <p className="text-brand-text-primary">Разместите ваш товар на главной странице и в топе категории на 7 дней.</p>
              <p className="text-4xl font-bold text-brand-primary mt-2">5 USDT</p>
          </div>
