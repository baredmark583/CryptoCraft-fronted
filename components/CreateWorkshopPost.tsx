    ...
    <div className="bg-brand-surface p-4 rounded-lg mb-8">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-between items-center">
          <label htmlFor="post-image-upload" className="cursor-pointer text-brand-text-secondary hover:text-brand-primary">
          ...
          <button
            ...
            className="bg-brand-primary hover:bg-brand-primary-hover text-white font-bold py-2 px-6 rounded-lg transition-colors flex items-center disabled:bg-gray-500"
          >
