    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-brand-surface rounded-2xl shadow-2xl w-full max-w-md border border-brand-border">
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <p className="text-brand-text-secondary text-sm mb-6">Для заказа <span className="font-mono text-brand-primary">{orderId}</span></p>

          <div className="mb-4">
            <label htmlFor="shipping-provider" className="block text-sm font-medium text-brand-text-secondary mb-2">Служба доставки</label>
            <input
          ...
          <div className="mb-6">
            <label htmlFor="tracking-number" className="block text-sm font-medium text-brand-text-secondary mb-2">Трек-номер</label>
            <input
              id="tracking-number"
              type="text"
